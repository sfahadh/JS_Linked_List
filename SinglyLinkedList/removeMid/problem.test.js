...
test("Return a linked list with mid node of data 6 removed", () => {
    ...
    expect(RemoveHead(generate.generateLinkedList(4, 7))).toEqual(outputList);
})
...
test("Return a linked list with mid node of data 3 removed", () => {
    ...
    expect(RemoveHead(generate.generateLinkedList(1, 5))).toEqual(outputList);
})
...
test("Return a linked list with mid node of data 10 removed", () => {
    ...
    expect(RemoveHead(generate.generateLinkedList(5, 15))).toEqual(outputList);
})
...
test("Return a linked list with mid node of data 9999 removed", () => {
    ...
    expect(RemoveHead(generate.generateLinkedList(9990, 10008))).toEqual(outputList);
})